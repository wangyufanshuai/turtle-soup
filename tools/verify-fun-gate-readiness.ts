...
const cleanContextReportPath = resolve(root, "docs/v1.8-fun-gate-clean-context.json");
...
const gates = {
  ...
  cleanContextVerified: existsSync(cleanContextReportPath) && JSON.parse(read("docs/v1.8-fun-gate-clean-context.json")).passed === true && JSON.parse(read("docs/v1.8-fun-gate-clean-context.json")).humanParticipants === 0,
