...
const serviceWorkerGuards = { profileScoped: sw.includes(v28 ? "black-soup-v28-guided-investigation-rc" : "black-soup-v27-player-first-rc"), sameOriginOnly: sw.includes("origin !== self.location.origin"), noRuntimeCachePut: !sw.includes("cache.put(") };
const historical = [
