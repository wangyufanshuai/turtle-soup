...
const serviceWorkerGuards = { profileScoped: sw.includes(v211 ? "black-soup-v211-action-loop-rc" : v210 ? "black-soup-v210-completed-archive-rc" : v29 ? "black-soup-v29-language-recovery-rc" : v28 ? "black-soup-v28-guided-investigation-rc" : "black-soup-v27-player-first-rc"), sameOriginOnly: sw.includes("origin !== self.location.origin"), noRuntimeCachePut: !sw.includes("cache.put(") };
const historical = [
