...
if (!sw.includes("black-soup-v16-internal-rc-1")) failures.push("v1.6 cache identity missing");
const report = { reportVersion: "1.6", releaseProfile: "v1.6-internal-rc", generatedAt: new Date().toISOString(), status: "internal-rc / human-evaluation-pending", humanParticipants: 0, budgets, actual, failures, passed: failures.length === 0 };
writeFileSync(resolve(root, "docs/v1.6-static-performance.json"), `${JSON.stringify(report, null, 2)}\n`, "utf8");
