...
const cacheName = profileId === "season1-v0.9-stable" ? "black-soup-v09-gm1" : profileId === "v1.0-internal-rc" ? "black-soup-v10-internal-rc1" : profileId === "v1.1-internal-rc" ? "black-soup-v11-internal-rc1" : profileId === "v1.2-internal-rc" ? "black-soup-v12-internal-rc1" : profileId === "v1.3-public-preview" ? "black-soup-v13-preview-1" : profileId === "v1.5-internal-rc" ? "black-soup-v15-golden-rc-1" : profileId === "v1.6-internal-rc" ? "black-soup-v16-internal-rc-1" : profileId === "v1.7-internal-rc" ? "black-soup-v17-golden-path-rc-1" : profileId === "v1.8-internal-rc" ? "black-soup-v18-golden-nine-hardening-rc-1" : profileId === "v1.9-internal-rc" ? "black-soup-v19-ai-language-bridge-rc-1" : profileId === "v2.0-internal-rc" ? "black-soup-v20-autonomous-experience-rc-1" : profileId === "v2.1-internal-rc" ? "black-soup-v21-experience-continuity-rc-1" : profileId === "v2.2-internal-rc" ? "black-soup-v22-cognitive-friction-rc-1" : profileId === "v2.3-internal-rc" ? "black-soup-v23-resolution-payoff-rc-1" : profileId === "v2.4-internal-rc" ? "black-soup-v24-investigation-rhythm-rc-1" : profileId === "v2.5-internal-rc" ? "black-soup-v25-season5-content-rc" : profileId === "v2.6-internal-rc" ? "black-soup-v26-investigation-workbench-rc" : "black-soup-v14-internal-rc-1";
...
const report = {
  reportVersion: profileId === "season1-v0.9-stable" ? "0.9" : profileId === "v1.0-internal-rc" ? "1.0" : profileId === "v1.1-internal-rc" ? "1.1" : profileId === "v1.2-internal-rc" ? "1.2" : profileId === "v1.3-public-preview" ? "1.3" : profileId === "v1.5-internal-rc" ? "1.5" : profileId === "v1.6-internal-rc" ? "1.6" : profileId === "v1.7-internal-rc" ? "1.7" : profileId === "v1.8-internal-rc" ? "1.8" : profileId === "v1.9-internal-rc" ? "1.9" : profileId === "v2.0-internal-rc" ? "2.0" : profileId === "v2.1-internal-rc" ? "2.1" : profileId === "v2.2-internal-rc" ? "2.2" : profileId === "v2.3-internal-rc" ? "2.3" : profileId === "v2.4-internal-rc" ? "2.4" : profileId === "v2.5-internal-rc" ? "2.5" : profileId === "v2.6-internal-rc" ? "2.6" : "1.4",
