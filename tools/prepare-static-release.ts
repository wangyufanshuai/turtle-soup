...
const report = {
  reportVersion: profileId === "season1-v0.9-stable" ? "0.9" : profileId === "v1.0-internal-rc" ? "1.0" : profileId === "v1.1-internal-rc" ? "1.1" : profileId === "v1.2-internal-rc" ? "1.2" : profileId === "v1.3-public-preview" ? "1.3" : "1.4",
