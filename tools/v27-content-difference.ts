...
const baselineId = v211 ? "v2.10-internal-rc" : v210 ? "v2.9-internal-rc" : v29 ? "v2.8-internal-rc" : v28 ? "v2.7-internal-rc" : "v2.6-internal-rc";
...
const report = {
  ...
  frozen,
  changes,
  scope: v211 ? "action hierarchy and post-solve continuation only; no truth, proof or save identity changes" : v210 ? "completed-case foregrounding, five-season navigation and onboarding deduplication only; no truth, proof or save identity changes" : v29 ? "language-recovery entry points, question reassurance and challenge budget visibility only; no truth, proof or save identity changes" : v28 ? "settings information architecture and guidance hierarchy only; no truth, proof or save identity changes" : "AI provider affordances, navigation copy and deterministic feedback only; no truth, proof or save identity changes",
